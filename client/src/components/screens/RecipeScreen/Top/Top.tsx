            ...
            <div className='flex gap-2'>
              ...
              <div className='border py-2 px-4 transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted rounded-lg'>
                ...
                <div className='flex gap-[3px] mt-2'>
                  <DifficultPoint active size='8' />
                  <DifficultPoint active={data.ingredients?.length > 4} size='8' />
                  <DifficultPoint active={data.ingredients.length > 8} size='8' />
                  <DifficultPoint active={data.ingredients.length > 12} size='8' />
                </div>
              </div>
            </div>
          </div>
